...
B About about.html
    Halaman yang merinci Biodata Riwayat Pendidikan dalam format Card dan daftar Pencapaian Pengalaman dalam format Akordeon.
C Portofolio portofolio.html
    Halaman utama yang menampilkan daftar proyek dalam format Card. Setiap proyek dapat dilihat detailnya menggunakan komponen Modal Pop-up.
D Report report.html
    Halaman yang menampilkan kumpulan laporan praktikum dalam format Card dilengkapi filter berdasarkan mata kuliah dan detail laporan.
E Contact contact.html
    Halaman yang menyediakan Formulir Kontak daftar Ikon Media Sosial dan penempatan lokasi melalui Google Maps.

4 FITUR UTAMA
A Desain responsif penuh (beradaptasi di berbagai ukuran layar).
